...
fun TermTagIcon(
    ...
    Canvas(modifier = modifier.defaultMinSize(minWidth = 20.dp, minHeight = 20.dp)) {
...
fun TermChevronRightIcon(
    ...
    Canvas(modifier = modifier.defaultMinSize(minWidth = 17.dp, minHeight = 17.dp)) {
        val scale = size.width / 24f
        drawPath(
            path = path,
            color = color,
...
fun TermEndIcon(
    ...
    Canvas(modifier = modifier.defaultMinSize(minWidth = 21.dp, minHeight = 21.dp)) {
        val scale = size.width / 24f
        drawCircle(
            color = color,
            radius = 9f * scale,
